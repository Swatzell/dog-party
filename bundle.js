...
.dog4 {
  ...
  border-radius: 50%;
  height: 225px;
}`, "",{"version":3,"sources":["webpack://./src/css/index.scss","webpack://./src/css/_variables.scss"],"names":[],"mappings":"AACA;EACE,aAAA;EACA,sBAAA;EACA,SAAA;AAAF;;AAIA;EACE,gEAAA;EACA,YAAA;EACA,WAAA;EACA,aAAA;EACA,uBAAA;EACA,sBAAA;EACA,mBAAA;EACA,kBAAA;AADF;;AAIA;EACE,mBAAA;EACA,eAAA;AADF;;AAIA;EAEE,yBCzBuB;ADuBzB;;AAOA;EACE,uBAAA;EACA,cCjCkB;EDkClB,yBAAA;AAJF;;AAQA;EACE,aAAA;EACA,yBAAA;EACA,iBAAA;EACA,kBAAA;AALF;;AAQA;;;EAGE,iBAAA;EACA,gBAAA;EACA,YAAA;AALF;;AAUA;EACE,WAAA;EACA,iBAAA;EACA,eAAA;AAPF;;AAUA;EACE,yBAAA;EACA,kBAAA;EACA,mBAAA;AAPF;;AAUA;EACE,aAAA;EACA,mBAAA;EACA,mBAAA;AAPF;;AAUA;EACE,yBAAA;EACA,kBAAA;AAPF;;AAUA;;EAEE,yBAAA;EACA,kBAAA;EACA,aAAA;AAPF","sourcesContent":["@import 'variables';\nbody {\n  display:flex;\n  flex-direction: column;\n  margin:0\n\n  \n}\n.what-are-dogs {\n  background: url('../../dist/images/park.jpg') center/cover;\n  height: 50vh;\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  align-items: center;\n  font-size: x-large;\n}\n\n.dog-site-header {\n  margin-bottom: 20px;\n  margin-top: 5px;\n}\n\nnav {\n  // Example of using a variable:\n  background-color: $secondary-accent-color;\n  \n}\n\n\nbutton {\n  background-color: white;\n  color: $main-accent-color;\n  border:3px solid $main-accent-color;\n}\n\n\n.nav-words {\n  display:flex;\n  justify-content: flex-end;\n  float: inline-end;\n  margin-right: 30px;\n}\n\n.how,\n.what,\n.facts {\n  margin-left: 20px;\n  font-size: large;\n  color: white;\n}\n\n\n\n.dog-icon {\n  width: 50px;\n  margin-left: 25px;\n  margin-top: 5px;\n}\n\n.dog1 {\n  border:5px solid $main-accent-color;\n  border-radius: 50%;\n  margin-bottom: 10px;\n}\n\n.how-what-facts {\n  display: flex;\n  align-items: center;\n  flex-direction: row;\n}\n\n.dog2 {\n  border:5px solid $main-accent-color;\n  border-radius: 50%;\n}\n\n.dog3,\n.dog4 {\n  border:5px solid $main-accent-color;\n  border-radius: 50%;\n  height:225px\n}","$main-accent-color: #3F8DA8;\n$secondary-accent-color: #92E0E5;"],"sourceRoot":""}]);
// Exports
